...
The results can be visualized in a web browser, using the online Gene Ontology visualizer REVIGO. As an example, prepare REVIGO input for the Biological Process (BP) results:
...
Copy the contents of the `revigo.BP.tsv` file and copy them in the text box on the main page of the REVIGO web site. The click the button `[Start Revigo]` and have a look at the results.
